...
import { TOTAL_STUDENTS, STUDENT_MASTER_LIST } from '../constants';
import { AgentCard } from './AgentCard';
import { PieChart, Pie, Cell, ResponsiveContainer } from 'recharts';
import { Share2, Zap, User, Search, Trophy, Calendar } from 'lucide-react';
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
              ...
              <div className="bg-yellow-900/20 backdrop-blur-sm p-3 rounded-xl border border-yellow-500/30">
                <p className="text-xs text-yellow-300 uppercase tracking-wider mb-1">Ranking #1</p>
              ...
              <div className="bg-red-900/20 backdrop-blur-sm p-3 rounded-xl border border-red-500/30">
                <p className="text-xs text-red-300 uppercase tracking-wider mb-1">Tiada Rekod</p>
